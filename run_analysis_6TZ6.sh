...
# ============================================================
# KULLANICI TARAFINDAN DEĞİŞTİRİLECEK BÖLÜM
# ============================================================
...
# ============================================================
# 0. INPUT KONTROLÜ VE ÇALIŞMA KLASÖRLERİ
# ============================================================

if [ ! -f "$INPUT_PDB" ]; then
    echo "HATA: $INPUT_PDB bulunamadı."
    exit 1
fi
...
# Dosya adlarını run klasörlerine bağla.
...
echo "  $TLEAP_PDB"
echo
echo "For 6TZ6, inspect RUN_REPORT.txt, residues_of_interest.tsv, and the regression check."
echo "If DELTA TOTAL reproduces approximately -92.9522 kcal/mol and"
echo "Mapping QC is PASS, the 6TZ6 v1.0 regression criteria are satisfied."
echo "=================================================================="
