#!/usr/bin/env python3
"""
ProDy ANM cross-correlation calculation for Calcineurin B subunit.
...
def main():
    ap = argparse.ArgumentParser(
        description="Calculate ProDy ANM cross-correlation matrices for B subunit."
    )
    ap.add_argument(
        "--bos",
    ...
    ap.add_argument(
        "--chain",
        default="B",
        help="Protein chain ID to analyze (default: B)",
    )
    ...
    analyze_structure(
        args.bos, "1TCO_B", args.chain,
        args.cutoff, args.gamma, args.modes,
        "1TCO_B_crosscorr.csv",
    )
    analyze_structure(
        args.candida, "6TZ6_B", args.chain,
        args.cutoff, args.gamma, args.modes,
        "6TZ6_B_crosscorr.csv",
    )
    ...
    print("=" * 72)
    print("Created:")
    print("  1TCO_B_crosscorr.csv")
    print("  6TZ6_B_crosscorr.csv")
    print("  1TCO_B_residues.csv")
    print("  6TZ6_B_residues.csv")
